    ...
    def __init__(self, msg):
        ...
        self.messages = {
            'start':'🤖 Hello My Name Is MHSDBoT , Your Self, '+ self.user_name +'!\n\n'
                    ...
                    'Develoveped By : @MutyalaHarshith',
            ...
            'invalid_command':'💔 *Use Commads Like This 👇👇*\n'
                    '/MusiC - Song Name or Musician\n'
                    '/MusiC - Chitti'
                    
                    'Develoveloped by : @MutyalaHarshith
    ...
    def process_request(self, user_input):
        ...
        if int(min_duration) < 30 and split_count < 3:
            ...
            try:
                ...
                self.send_message('Successfully Generated By @MutyalaHarshith')
                print ("\nSucess!\n")
            except:
                print("\nError")
